    ...
    <>
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody pb="2rem">
            <Text textAlign="center" fontSize="1.3rem">Vote for the spots of the teams!</Text>
            <Text textAlign="center" fontSize="1.3rem">You have 30 spots in total.</Text>
            <Text textAlign="center" fontSize="1.3rem">The teams are sorted by arithmetic mean.</Text>
            <Text textAlign="center" fontSize="1.3rem">The page reloads once you have voted.</Text>
          </ModalBody>
          <ModalCloseButton />
        </ModalContent>
      </Modal>
...
const Home = ({ teamsData }) => {
  ...
  const { isOpen, onOpen, onClose } = useDisclosure()
  const { isOpenInfo, onOpenInfo, onCloseInfo } = useDisclosure()
