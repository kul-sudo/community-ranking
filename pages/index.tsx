...
const Home = ({ teamsData }) => {
  ...
  return (
    <>
      ...
      <IconButton width="3rem" height="3rem" position="fixed" top="0" left="0" colorScheme={useColorModeValue('teal', 'blue')} borderTopLeftRadius="0" borderTopRightRadius="0" borderBottomLeftRadius="0" borderBottomRightRadius="25%" onClick={toggleColorMode} icon={useColorModeValue(<MoonIcon boxSize="1.3rem" />, <SunIcon boxSize="1.3rem" />)} />
